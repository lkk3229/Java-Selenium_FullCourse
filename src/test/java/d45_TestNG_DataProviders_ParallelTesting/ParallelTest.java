...
=========================================
1. create test case
2. create xml file to run the test case
3. passed browser name parameter from xml file and received in setup() method
4. Execute test cases on chrome, firefox & Edge (Serial Execution)
5. Execute test case on chrome, firefox & Edge (parallel execution)

*/

//try to keep thread count = 5  in xml filr not more than that
