...
public class DataProviderDemo {
	...
	void testLogin(String email, String pwd) throws InterruptedException
	{
		...
		if(status==true)
		{
			driver.findElement(By.xpath("//a[@class='list-group-items'][normalize-space()='Logout']")).click();
	...
	@DataProvider(name="dp", indices= {0,3,4})  //indices defines which range of data to test
	Object[][] loginData()
	{
		Object data[][]= { 
